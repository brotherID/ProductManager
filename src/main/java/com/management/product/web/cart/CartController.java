...
public interface CartController {
    ...
    ResponseEntity<ShoppedProductResponse> addProductToCart(@PathVariable(name = PATH_VARIABLE_ID_PRODUCT) Long idProduct,@PathVariable(name= PATH_VARIABLE_QUANTITY_REQUESTED) Integer quantityRequested);
}
